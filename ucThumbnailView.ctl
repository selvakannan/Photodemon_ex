...
Private m_eColumnSortOrder(4)  As tvSortOrderConstants
...
Public Function Initialize(ByVal FormatsMask As String, _
                           ...
                           Optional ByVal DateColumnWidth As Long = 100, _
                           Optional ByVal crcColumnWidth As Long = 100) As Boolean
    
    If (m_bInitialized = False) Then
    
        Initialize = pvCreate(FormatsMask, MaskSeparator, ViewMode, NameColumnWidth, TypeColumnWidth, SizeColumnWidth, DateColumnWidth, crcColumnWidth)
...
Public Function ItemAdd( _
  ...
  Dim uITI As IMAGETYPE_INFO
    ...
    If (m_hListView) Then
        ...
        Call pvSubItemSet(Item, 4, Filecrc)
    End If
End Function
...
Private Function pvCreate(ByVal FormatsMask As String, _
                          ...
                          ByVal DateColumnWidth As Long, _
                          ByVal crcColumnWidth As Long) As Boolean
  ...
  Dim lLVStyle As Long
    ...
    If (m_hListView) Then
        ...
        Call pvColumnAdd(4, "crc", crcColumnWidth)
  ...
  Dim lCol As Long
    ...
    If (m_hListView) Then
        ...
        Select Case lColumnID
            ...
            Case 4: pvSort = mListViewSort.Sort(m_hListView, 4, m_eColumnSortOrder(4), [tvString])
        End Select
    End If
End Function
